package io.research.research_assistant.service;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.research.research_assistant.entity.GeminiResponse;
...
public class ResearchService {
    ...
    public String processContent(ResearchRequest request) {
        ...
        // Parse the response
        String extractedTextResponse = extractTextFromResponse(response);
